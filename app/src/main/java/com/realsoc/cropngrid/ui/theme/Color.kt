...
val md_theme_light_secondaryContainer = Color(0xFF70F7F1)
...
val md_theme_light_surfaceVariant = Color(0xFFF8F9FB)//Color(0xFFDCE4E8)
val md_theme_light_onSurfaceVariant = Color(0xFF191C1E)// Color(0xFF40484C)
...
val md_theme_dark_secondary = Color(0xFF4EDAD5)
val md_theme_dark_onSecondary = Color(0xFF003735)
val md_theme_dark_secondaryContainer = Color(0xFF00504D)
val md_theme_dark_onSecondaryContainer = Color(0xFF70F7F1)
val md_theme_dark_tertiary = Color(0xFFFFB878)
...
val md_theme_dark_surfaceVariant = Color(0xFF40484C)//Color(0xFF40484C)
val md_theme_dark_onSurfaceVariant = Color(0xFFC0C8CC)


val seed = Color(0xFF006782)
