...
/**
 * Wrap Material [androidx.compose.material.Scaffold] and set [CropNGrid] colors.
 */
@Composable
fun CropNGridScaffold(
...
/**
 * Remember and creates an instance of [CropNGridScaffoldState]
 */
@Composable
fun rememberCropNGridScaffoldState(
    snackbarHostState: SnackbarHostState = remember { SnackbarHostState() },
    snackbarManager: SnackbarManager = SnackbarManager,
    resources: Resources = resources(),
    coroutineScope: CoroutineScope = rememberCoroutineScope()
): CropNGridScaffoldState = remember(snackbarManager, resources, coroutineScope) {
    CropNGridScaffoldState(snackbarHostState, snackbarManager, resources, coroutineScope)
}
